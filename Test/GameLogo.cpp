...
void GameLogo::init(std::string vertShader, std::string fragShader, int screenWidth, int screenHeight, glm::vec2 cameraPosition, float cameraZoom, Ackerfe::OSInterface* window, Ackerfe::GraphicsResourceManager* graphics)
{
...
void GameLogo::logoUpdateRenderLoop()
{
	...
	mGraphics->mMultiSprite2D.addSprite(Ackerfe::loadPng("Texture/Logostate/Astro_sloth_entertainment2.png"), 0.0f,
