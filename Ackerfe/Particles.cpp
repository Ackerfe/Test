...
namespace Ackerfe
{
	...
	void ParticleEmitterCone::init(glm::vec3 position, float emitterSize, glm::vec3 travelVec, float maxDisplacement, int particlesInWorld, unsigned int particleLife)
	...
	std::vector<glm::vec3>  ParticleEmitterCone::getParticlePosition()
	{
