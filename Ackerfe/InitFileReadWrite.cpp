...
namespace Ackerfe
{
	...
	std::vector<std::string> Ackerfe::readInitFile()
	{
		...
		{
			Ackerfe::throwFileError("Initialization", "The initialization file is missing or corrupt.");
		}
		return returnVector;
	}
	...
	std::vector<std::string> Ackerfe::readFile(std::string & filePath)
	{
		std::vector<std::string> returnVector;
	...
	void Ackerfe::writeInitFile(std::vector<std::string> initContents)
	{
		...
		{
			Ackerfe::throwFileError("Initialization", "The initialization file could not be created.");
		}
	}
